...
hold on 
RGB=[255,140,0]./255;
%h4=scatter(4.86,6.505,markersize,RGB,'filled','s')
hold on
...
hold on
c2=0:0.01:9.72;
a_99_CI_lower2=0.6461*c2+1.939;
a_99_CI_upper2=0.6787*c2+2.114;
...
pbaspect(ratio)
set(gca,'box','off')
legend([h1,h2,h3,h4],{'LHS samples','uncertanity range around optimal estimates',...
    'regression line of the form d=b\timesc+a','95% CI around regression fit'},'Box','off',...
